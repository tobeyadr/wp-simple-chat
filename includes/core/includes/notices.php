	...
	public function notices() {
		...
		foreach ( $notices as $notice ) {
			...
			<div id="<?php esc_attr_e( $notice['code'] ); ?>"
			     class="notice <?php echo $this->get_filter_prefix(); ?>-notice notice-<?php esc_attr_e( $notice['type'] ); ?> <?php if ( $notice['dismissible'] ) {
				     echo 'is-dismissible';
			     } ?>"><p><strong><?php echo wp_kses_post( $notice['message'] ); ?></strong></p>
